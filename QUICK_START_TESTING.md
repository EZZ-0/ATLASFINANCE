# 🚀 QUICK START - TEST INVESTMENT SUMMARY NOW!
...
**If all visible:** ✅ Visual test PASS
...
**Go to Extract tab → Ratios subtab:**
- Find ROE in table
- Does it match? [ ] YES

**If matches:** ✅ Data accuracy PASS
...
**If both sound good:** ✅ Intelligence PASS
...
- **Check:** Does Bear case mention "debt" or "leverage"?
  - [ ] YES → ✅ High-leverage detection works
